...
export class EntitySheetHelper {
  ...
  static onAttributeRoll(event) {
    ...
    const shorthand = game.settings.get("pokemon-pta3", "macroShorthand");
  ...
  static async createDialog(data={}, options={}) {
    ...
    const templates = collection.filter(a => a.getFlag("pokemon-pta3", "isTemplate"));
    ...
    return Dialog.prompt({
      ...
      callback: html => {
        ...
        if ( template ) {
          ...
          delete createData.flags['pokemon-pta3'].isTemplate;
        }
